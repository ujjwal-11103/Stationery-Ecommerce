  ...
  return (
    <div className="footer">
      <div className="l">
        ...
        <div className="b">
          <h1>
            Sign up for our Urban Space newsletter. You'll be the first to hear about
        ...
        <div className="sl">
          ...
          <ul>
            ...
            <li>
              <Link target="_black" href={"https://facebook.com/"}>
                <svg
      ...
      <div className="w">
        ...
        <div className="menu">
          ...
          <ul className="p">
            <ul>
              <li>
                <Link href={"/productPage"}>About</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Shipping FAQ</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Contact</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Custom Production</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Terms of Service</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Privacy Policy</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Refund policy</Link>
              </li>
            </ul>
            <ul>
              <li>
                <Link href={"/productPage"}>Help FAQ</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Returns</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Journal</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Wholesale</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Accessibility</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Terms of Service</Link>
              </li>
              <li>
                <Link href={"/productPage"}>Store Location</Link>
              </li>
            </ul>
          </ul>
        </div>
