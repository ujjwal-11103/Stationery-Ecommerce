    ...
    <>
      ...
      <div className={`header ${c} ${s}`}>
        <div className="upside">
          ...
          >
            NEW limited edition Urban Space x Crow Canyon Home Collection is here!
            Shop Now
          </Link>
        </div>
        <div className={`downside`}>
          <Link onClick={closex} href={"/productPage"}>
            <Image
              alt="logo"
              width={300}
              height={280}
          ...
          <div className="right">
            ...
            <Link
              onClick={closex}
              href={"/cart"}
              className={`cart ${h == true ? "e" : h == false ? "l" : ""} ${sidebar && "disabled"
                }`}
